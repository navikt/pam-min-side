    ...
    return (
        <>
            <BodyLong className="mb-6">
                NAV er ansvarlig for at personopplysninger blir behandlet etter personopplysningsloven. Det er frivillig å ta i bruk tjenestene.
            </BodyLong>
            <BodyLong className="mb-6">
                I{" "}
            ...
            <BodyLong className="mb-6">
                Det er kun du som som har tilgang til dine lagrede søk og favoritter. Vi deler hverken disse eller din e-postadresse med andre.
            </BodyLong>
            <Heading level="4" size="small">
            ...
            <BodyLong>
                Du kan når som helst slette samtykket ditt inne på dine innstillinger. Når du sletter ditt samtykke vil dine lagrede søk og favoritter slettes, i tillegg til e-postadressen for varsel dersom du har oppgitt det.
            </BodyLong>
        </>
    );
}
